  ...
  return (
    <>
      <div className="w-full h-screen bg-white dark:bg-black flex items-center justify-center">
        <Card className="w-100 h-100 dark:bg-gray-800 bg-red-400 flex flex-col p-4">
          ...
          <div className="flex-1 flex items-center justify-center">
            ...
            >
              <Button type="submit">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="15" height="15">
